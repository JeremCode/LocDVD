...
import com.example.locdvd.LocalSQLiteOpenHelper;
...
public class DVD {
    ...
    public static ArrayList<DVD> getDVDList(Context context) {
        ...
        Cursor cursor = db.query(true, "DVD", new String[]{"id",
                        "titre", "annee", "acteurs", "resume" , "dateVisionnage"}, null,
                null,null,null,"titre", null  );
    ...
    public static DVD getDVD(Context context, long id) {
        ...
        Cursor cursor = db.query(true, "DVD", new String[]{"id",
                        "titre", "annee", "acteurs", "resume" , "dateVisionnage"}, where,
                null,null,null,"titre", null  );
